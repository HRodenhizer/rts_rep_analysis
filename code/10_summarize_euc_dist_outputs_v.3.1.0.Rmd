...
```{r}
euc_dist = rast('./euclidean_distance/polygon_counts_1_2_v.3.1.0.tif')
...
ggplot(pca_df, aes(x = PC1, y = PC2)) +
  ...
  geom_point(
    data = arts_pc |> 
      filter(RegionName == "Svalbard, Norway"),
    aes(
      x = PC1, 
      y = PC2,
      color = 'Svalbard'
  ...
  geom_point(
    data = arts_pc |> 
      filter(RegionName == "Lena" | RegionName == "Lower Lena, Russia"),
    aes(x = PC1, y = PC2,
    color = 'Lena River'),
    alpha = 0.5,
    inherit.aes = FALSE
  ...
  geom_point(
    data = arts_pc |> 
      filter(RegionName == "Batagay, Russia"),
    aes(x = PC1, y = PC2,
    color = 'Batagay'),
    alpha = 0.5,
    inherit.aes = FALSE
  ...
  scale_color_manual(
    name = "Select Regions",
    values = c('darkred', 'darkorange', 'gold', 'darkgreen')
    )

# ggsave('./figures/rts_over_pca_regions_v.3.1.0.pdf',
#        height = 6.5,
#        width = 6.5)
# ggsave('./figures/rts_over_pca_regions_v.3.1.0.jpg',
#        height = 6.5,
#        width = 6.5)
...
# ggsave('./figures/rts_over_pca_v.3.1.0.pdf',
#        height = 6.5,
#        width = 6.5)
# ggsave('./figures/rts_over_pca_v.3.1.0.jpg',
#        height = 6.5,
#        width = 6.5)
```
