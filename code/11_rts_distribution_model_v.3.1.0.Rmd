...
# )
#
# artsv1_filter = artsv1 |>
#   st_filter(artsv1_pos,
#             .predicate = st_within)
#
# st_write(
#   artsv1_filter,
...
artsv3_filter = artsv3 |>
  st_filter(artsv3_pos, .predicate = st_within)
...
ggplot() +
  ...
  geom_spatraster(data = rts_probability_median, maxcell = 1e+07) +
  scale_fill_viridis(
...
```{r}
rts_probability_median_old = rast(
  './sdm/gbm_kfold_10_pred_tuned_median_v.1.0.1_filter.tif'
)

rts_probability_diff_update = rts_probability_median -
  rts_probability_median_old
```
...
# ggsave('./figures/rts_probability_diff_filter_v.3.1.0-v.1.0.1.jpg',
#        height = 5,
#        width = 6.5)
```
...
rts_presence_list = map(
  cutoffs,
  ~ classify_rts(rts_probability_median, .x)
)
