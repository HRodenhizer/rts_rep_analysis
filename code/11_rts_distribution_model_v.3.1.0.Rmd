...
```{r}
rts_area = zonal(
  cellSize(rts_presence_pred),
  rts_presence_pred,
  fun = sum
)

rts_area = rts_area |>
  mutate(area = area / (1000 * 1000)) # convert to km^2 from m^2

rts_area

# Percent of our study region susceptible to RTS (about 5%)
(rts_area |>
...
# Percent of Arctic Boreal Region susceptible to RTS (about 3%)
(rts_area |>
  filter(rts_presence == "RTS") |>
  pull(area)) /
  (arctic_boreal |>
