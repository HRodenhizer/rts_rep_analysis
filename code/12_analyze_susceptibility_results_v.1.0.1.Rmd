...
arts = st_read(
  ...
  st_make_valid()
arts_grid = read_csv('./sdm/arts_grid_filter_v.1.0.1.csv')
...
# writeRaster(
#   rts_prob_diff,
#   "./sdm/rts_probability_diff_makopoulou-ARTSv.1.0.1.tif"
# )
```
...
# ggsave('./figures/rts_prob_diff_v.1.0.1.jpg',
#        height = 6,
#        width = 6)
...
# ggsave('./figures/rts_susceptibility_diff_v.1.0.1.jpg',
#        height = 6,
#        width = 8)
```
