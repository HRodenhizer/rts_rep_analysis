...
```{r}
# saveRDS(rts_model,
#         './sdm/rts_gbm_kfold_10.rds')
# 

rts_model = readRDS('./sdm/rts_gbm_kfold_10.rds')
```
...
```{r}
# rts_pred <- BIOMOD_Projection(bm.mod = rts_model,
#                                   proj.name = 'Current',
#                                   new.env = pca,
#                                   models.chosen = 'all',
...
```{r}
# saveRDS(rts_pred,
#         './sdm/rts_gbm_kfold_10_pred.rds')

rts_pred = readRDS('./sdm/rts_gbm_kfold_10_pred.rds')
```
...
# ggsave('./figures/gbm_kfold_10_pred_all.jpg',
#        height = 5,
#        width = 6.5)
...
# ggsave('./figures/gbm_kfold_10_pred.jpg',
#        height = 5.5,
#        width = 6.5)
```
