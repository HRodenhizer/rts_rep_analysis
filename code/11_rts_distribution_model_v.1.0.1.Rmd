...
train_arts_filter = arts |>
  st_filter(roi_arts_pos,
            .predicate = st_within)
...
ggplot() +
  ...
  geom_sf(data = arts,
          ...
          linewidth = 1,
          color = 'red') +
  geom_sf(data = roi_arts_pos,
          size = 0.2,
          linewidth = 1,
          fill = 'transparent') +
  geom_sf(data = train_arts_filter,
...
# write_csv(
#   arts_grid,
#   './sdm/arts_grid_filter_v.1.0.1.csv'
# )
...
rts_probability_median = rast('./sdm/gbm_kfold_10_pred_tuned_median_v.1.0.1_filter.tif')
```
...
# ggsave('./figures/rts_probability_median_filter_v.1.0.1.jpg',
#        height = 5,
#        width = 6.5)
...
# ggsave('./figures/rts_probability_median_filter_w_arts_v.1.0.1.jpg',
#        height = 5,
#        width = 6.5)
# ggsave('./figures/rts_probability_median_filter_w_arts_v.1.0.1.pdf',
#        height = 5,
#        width = 6.5)
```
...
# ggsave('./figures/rts_susceptibility_filter_v.1.0.1.jpg',
#        height = 6,
#        width = 6.5)

# ggsave('./figures/rts_susceptibility_filter_blue_red_v.1.0.1.jpg',
#        height = 6,
#        width = 6.5)
```
...
#             './sdm/rts_presence_pred_filter_v.1.0.1.tif')
```
...
# ggsave('./figures/rts_presence_pred_filter_v.1.0.1.jpg',
#        height = 6,
#        width = 6.5)
```
...
# ggsave('./figures/rts_coefficient_of_variation_filter_v.1.0.1.jpg',
#        height = 5,
#        width = 6.5)

# ggsave('./figures/rts_coefficient_of_variation_filter_red_v.1.0.1.jpg',
#        height = 5,
#        width = 6.5)
```
