...
for (pixel_idx in 1:n_pixels) {
  ...
  current_counts = c(
      ...
      length(euc_dist[euc_dist <= 5])
    )
  
  counts[pixel_idx,] = current_counts
...
## Test with one polygon and all pixels
Went from 2.16 minutes to 25 seconds when progress bar was removed...

Why isn't this changing when I switch out the polygon?
...
# ggsave('./figures/euc_dist_poly_628.jpg',
#        height = 6, width = 6.5)
```
