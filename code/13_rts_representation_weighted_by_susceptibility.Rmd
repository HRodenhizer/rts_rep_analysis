...
rts_rep_difference = rts_prob_rescale - euc_dist_rescale
rts_rep_difference[rts_rep_difference < 0] = 0 
names(rts_rep_difference) = c('rts_data_need')
...
The difference approach seems to work better mathematically for determining knowledge gaps.
...
# ggsave(
#   './figures/rts_knowledge_gaps_difference_woodwell_filter.jpg',
#   height = 6,
#   width = 8
# )
```
