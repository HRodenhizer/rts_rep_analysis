...
rts_rep_difference = c(
  calc_data_need(rts_prob_rescale, euc_dist_rescale, "data_need_norm_both"),
  calc_data_need(rts_probability/100, euc_dist_rescale, "data_need_norm_dist")
)
...
#   )
# rts_rep_difference = rast('./data_gaps/rts_data_gaps_filter_v.1.0.1.tif')
```

```{r}
ggplot() +
  geom_sf(data = world) +
  geom_spatraster(data = rts_rep_difference,
                  maxcell = 1e+07) +
  ...
  facet_wrap(~lyr) +
  ggtitle('RTS Knowledge Gaps (RTS Probability - RTS Count)')

# ggsave(
#   './figures/rts_knowledge_gaps_difference_woodwell_filter_v.1.0.1.jpg',
#   height = 6,
#   width = 8
# )
```
